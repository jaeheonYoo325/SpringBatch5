...
import com.springbatch.edu.SpringBatch5.entity.CustomBeforeRowMapper;
...
public class SixthBatch {
    ...
    public SixthBatch(JobRepository jobRepository, PlatformTransactionManager platformTransactionManager, BeforeRepository beforeRepository, AfterRepository afterRepository, DataSource dataSource) {
